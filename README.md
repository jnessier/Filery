...
|`filery_api_token` (Default: false) | ***Optional*** Is a token which can be send to the API for custom API configurations.|
|`filery_dialog_height` (Default: 400px) |***Optional*** Can be used to customize the dialog height.|
